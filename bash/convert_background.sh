...
#SBATCH --output=/home/a_morelli/vscode_projects/model_training/results/convert_background.out
#SBATCH --error=/home/a_morelli/vscode_projects/model_training/results/convert_background.err
...
$ENV_PYTHON -m src.scripts.convert_background 