...
#SBATCH --output=/home/a_morelli/vscode_projects/model_training/results/add_columns.out
#SBATCH --error=/home/a_morelli/vscode_projects/model_training/results/add_columns.err
...
$ENV_PYTHON -u -m src.scripts.add_columns_to_training_df