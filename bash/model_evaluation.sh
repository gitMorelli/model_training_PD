...
#SBATCH --output=/home/a_morelli/vscode_projects/model_training/results/evaluation/eval_handedness.out
#SBATCH --error=/home/a_morelli/vscode_projects/model_training/results/evaluation/eval_handedness.err
...
cd $HOME_DIR
# --- Execution ---
$ENV_PYTHON -m src.debug.model_evaluation \
    --num_workers 4