...
#SBATCH --output=/home/a_morelli/vscode_projects/model_training/results/inspect_models.out
#SBATCH --error=/home/a_morelli/vscode_projects/model_training/results/inspect_models.err
...
cd $HOME_DIR
# --- Execution ---
$ENV_PYTHON -m src.scripts.inspect_model